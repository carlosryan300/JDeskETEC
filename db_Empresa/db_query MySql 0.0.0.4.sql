...
insert controle(id_ser,id_gas)values(1,2),(2,4),(5,3),(3,5); 

select controle.id , (sum(servico.valorCobrado) - sum(gastos.valor)) diferenca
from controle,gastos , servico
where controle.id_gas=controle.id;
