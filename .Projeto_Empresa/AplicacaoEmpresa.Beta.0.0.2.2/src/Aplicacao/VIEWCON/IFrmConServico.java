...
public class IFrmConServico extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        cbTipoProduto = new javax.swing.JComboBox<String>();
        jLabel18 = new javax.swing.JLabel();
        cbTipoServico = new javax.swing.JComboBox<String>();
        ...
        cbConsulta = new javax.swing.JComboBox<String>();
        ...
        PainelPrinipal.setBorder(javax.swing.BorderFactory.createBevelBorder(0));
        ...
        PanelCliente.setBorder(javax.swing.BorderFactory.createBevelBorder(0));
        ...
        TabelaConsulta.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "Sobrenome", "Apelido", "CPF", "Celular", "Telefone", "Placa", "Modelo", "Marca", "Cor", "Tipo de Serviço", "Valor do Serviço ", "Data de Cadastro"
            }
        ));
        ...
        if (TabelaConsulta.getColumnModel().getColumnCount() > 0) {
            TabelaConsulta.getColumnModel().getColumn(0).setMinWidth(15);
        }
    ...
    private void TabelaConsultaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelaConsultaMouseClicked
        if (evt.getClickCount() == 1) {
            lblCod.setText(TabelaConsulta.getValueAt(TabelaConsulta.getSelectedRow(), 0).toString());
            txtNome.setText(TabelaConsulta.getValueAt(TabelaConsulta.getSelectedRow(), 1).toString());
            txtSobrenome.setText(TabelaConsulta.getValueAt(TabelaConsulta.getSelectedRow(), 2).toString());
            txtApelido.setText(TabelaConsulta.getValueAt(TabelaConsulta.getSelectedRow(), 3).toString());
            txtCPF.setText(TabelaConsulta.getValueAt(TabelaConsulta.getSelectedRow(), 4).toString());
            txtCelular.setText(TabelaConsulta.getValueAt(TabelaConsulta.getSelectedRow(), 5).toString());
            txtTelefone.setText(TabelaConsulta.getValueAt(TabelaConsulta.getSelectedRow(), 6).toString());
            txtPlaca.setText(TabelaConsulta.getValueAt(TabelaConsulta.getSelectedRow(), 7).toString());
            cbModelo.setSelectedItem(TabelaConsulta.getValueAt(TabelaConsulta.getSelectedRow(), 8).toString());
            cbMarca.setSelectedItem(TabelaConsulta.getValueAt(TabelaConsulta.getSelectedRow(), 9).toString());
            cbCor.setSelectedItem(TabelaConsulta.getValueAt(TabelaConsulta.getSelectedRow(), 10).toString());
            cbTipoServico.setSelectedItem(TabelaConsulta.getValueAt(TabelaConsulta.getSelectedRow(), 11).toString());
            txtValorCobrado.setText(TabelaConsulta.getValueAt(TabelaConsulta.getSelectedRow(), 12).toString());
            txtData.setText(TabelaConsulta.getValueAt(TabelaConsulta.getSelectedRow(), 13).toString());
